...
(function() {
  ...
  var u, y = document,
    ...
    Za, $a, Kb = {},
    tb = 0,
    cb, L, bb, sa, ub, B, Ea = function() {},
    Y = [],
    Ja = "div",
    O = "none",
    Pb = /^[0-9]+$/,
    Lb = "stroke-width",
    db, Ra, pb, qb, rb, Xa, eb, fb, Db, Eb, sb, Fb, Gb, J = {},
    Q = G.Highcharts = G.Highcharts ?
    oa(16, !0) : {};
  bb = function(a, b, c) {
  ...
  s(Q.Pointer.prototype, {
    ...
    pinch: function(a) {
      var b = this,
        ...
        l = b.selectionMarker,
        m = {},
        n = g === 1 && (b.inClass(a.target, "highcharts-tracker") && c.runTrackerClick || c.runChartClick),
        q = {};
...
(function(l, C) {
  ...
  r(z, "getLabelPosition", function(a, b, c, d, f, g, e, k, n) {
    var m = this.axis,
      i = g.y,
      j = g.align,
      h = (m.translate(this.pos) + m.startAngleRad + Math.PI / 2) / Math.PI * 180 % 360;
    m.isRadial ? (a = m.getPosition(this.pos, m.center[2] / 2 + q(g.distance, -25)), g.rotation === "auto" ? d.attr({
      rotation: h
    }) : i === null && (i = m.chart.renderer.fontMetrics(d.styles.fontSize).b -
      d.getBBox().height / 2), j === null && (j = m.isCircular ? h > 20 && h < 160 ? "left" : h > 200 && h < 340 ? "right" : "center" : "center", d.attr({
      align: j
    })), a.x += g.x, a.y += i) : a = a.call(this, b, c, d, f, g, e, k, n);
    return a
  });
  ...
  G = {
    ...
    translate: function() {
      ...
      t(this.points, function(d) {
        var f = o(b.dial, d.dial),
          g = w(q(f.radius, 80)) * c[2] / 200,
          e = w(q(f.baseLength, 70)) * g / 100,
          k = w(q(f.rearLength, 10)) * g / 100,
          n = f.baseWidth || 3,
          m = f.topWidth || 1,
          i = b.overshoot,
        ...
        d.shapeType = "path";
        d.shapeArgs = {
          d: f.path || ["M", -k, -n / 2, "L", e, -n / 2, g, -m / 2, g, m / 2, e, n / 2, -k, n / 2, "z"],
          translateX: c[0],
          translateY: c[1],
          rotation: j
        };
  ...
  h.boxplot = x(h.column, {
    ...
    drawPoints: function() {
      var a =
        ...
        c = a.options,
        d = a.chart.renderer,
        f, g, e, k, n, m, i, j, h, l, p, H, r, o, I, u, x, s, v, w, z, y, E = a.doQuartiles !== !1,
      ...
      t(b, function(b) {
        ...
        y = b.color || a.color;
        if(b.plotY !== C)
          if(f = b.pointAttr[b.selected ? "selected" : ""], x = z.width, s = A(z.x), v = s + x, w = D(x / 2), g = A(E ? b.q1Plot : b.lowPlot), e = A(E ? b.q3Plot : b.lowPlot), k = A(b.highPlot), n = A(b.lowPlot), p.stroke = b.stemColor || c.stemColor || y, p["stroke-width"] = q(b.stemWidth, c.stemWidth, c.lineWidth), p.dashstyle =
            b.stemDashStyle || c.stemDashStyle, o.stroke = b.whiskerColor || c.whiskerColor || y, o["stroke-width"] = q(b.whiskerWidth, c.whiskerWidth, c.lineWidth), u.stroke = b.medianColor || c.medianColor || y, u["stroke-width"] = q(b.medianWidth, c.medianWidth, c.lineWidth), u["stroke-linecap"] = "round", i = p["stroke-width"] % 2 / 2, j = s + w + i, l = ["M", j, e, "L", j, k, "M", j, g, "L", j, n, "z"], E && (i = f["stroke-width"] % 2 / 2, j = A(j) + i, g = A(g) + i, e = A(e) + i, s += i, v += i, H = ["M", s, e, "L", s, g, "L", v, g, "L", v, e, "L", s, e, "z"]), B && (i = o["stroke-width"] % 2 / 2, k += i, n += i, r = ["M", j -
              w * B, k, "L", j + w * B, k, "M", j - w * B, n, "L", j + w * B, n
            ]), i = u["stroke-width"] % 2 / 2, m = D(b.medianPlot) + i, I = ["M", s, m, "L", v, m, "z"], h) b.stem.animate({
            d: l
  ...
  h.waterfall = x(h.column, {
    ...
    getGraphPath: function() {
      var a = this.data,
        b = a.length,
        c = D(this.options.lineWidth + this.options.borderWidth) %
        2 / 2,
        d = [],
        f, g, e;
  ...
  L.prototype.beforePadding = function() {
    var a = this,
      ...
      k = this.min,
      n = {},
      m = v.min(c.plotWidth, c.plotHeight),
      i = Number.MAX_VALUE,
      j = -Number.MAX_VALUE,
      h = this.max - k,
      l = b / h,
    ...
    this.tickPositions && (t(this.series, function(b) {
      ...
      if(b.bubblePadding && (b.visible || !c.options.chart.ignoreHiddenSeries))
        if(a.allowZoomOutside = !0, p.push(b), g) t(["minSize", "maxSize"], function(a) {
          var b = e[a],
            g = /%$/.test(b),
            b = w(b);
          n[a] = g ? m * b / 100 : b
      ...
      if(h > 0)
        for(; c--;) typeof b[c] === "number" && (m = a.radii[c], d = Math.min((b[c] - k) * l - m, d), f = Math.max((b[c] - k) * l + m, f))
...
(function(j) {
  ...
  j.extend(n.prototype, {
    ...
    parseGoogleSpreadsheet: function() {
      ...
      c && jQuery.ajax({
        ...
        success: function(a) {
          ...
          for(l = 0; l < j; l++)
            if(c = a[l], f = c.gs$cell.row - 1, k = c.gs$cell.col - 1, k >= i && k <= g && f >= e && f <= h) d[k - i][f - e] = c.content.$t;
          b.dataFound()
        }
      })
    },
    ...
    parseTypes: function() {
      for(var b =
          this.columns, a = b.length, c, d, e, h; a--;)
        for(c = b[a].length; c--;) d = b[a][c], e = parseFloat(d), h = this.trim(d), h == e ? (b[a][c] = e, e > 31536E6 ? b[a].isDatetime = !0 : b[a].isNumeric = !0) : (d = this.parseDate(d), a === 0 && typeof d === "number" && !isNaN(d) ? (b[a][c] = d, b[a].isDatetime = !0) : b[a][c] = h === "" ? null : h)
    },
    dateFormats: {
      "YYYY-mm-dd": {
    ...
    complete: function() {
      ...
      if(d.complete) {
        ...
        for(g = 0; g < b.length; g++)
          if(this.headerRow === 0) b[g].name = b[g].shift();
        h = [];
        for(g = 0, k = 0; g < b.length; k++) {
          e = j.pick(this.valueCount.individual[k], this.valueCount.global);
          i = [];
          if(g + e <= b.length)
            for(f = 0; f < b[g].length; f++) i[f] = [a[f], b[g][f] !== void 0 ? b[g][f] : null], e > 1 && i[f].push(b[g + 1][f] !== void 0 ? b[g + 1][f] : null), e > 2 && i[f].push(b[g + 2][f] !== void 0 ? b[g + 2][f] : null), e > 3 && i[f].push(b[g + 3][f] !== void 0 ? b[g + 3][f] : null), e > 4 && i[f].push(b[g + 4][f] !== void 0 ? b[g + 4][f] : null);
          h[k] = {
            name: b[g].name,
            data: i
          };
