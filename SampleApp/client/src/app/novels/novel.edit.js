define([], function() {
  var diName = 'NovelEditCtrl';
  return {
    __register__: function(mod) {
      mod.controller(diName, ['$rootScope', '$scope', '$state', '$window', '$location', 'ds.novel', '$log', NovelEditCtrl]);
      return mod;
    }
  };

  function NovelEditCtrl($rootScope, $scope, $state, $window, $location, DS, $log) {
