define([], function() {
  var diName = 'TvPlayEditCtrl';
  return {
    __register__: function(mod) {
      mod.controller(diName, ['$rootScope', '$scope', '$state', '$window', '$location', 'ds.tvPlay', '$log', TvPlayEditCtrl]);
      return mod;
    }
  };

  function TvPlayEditCtrl($rootScope, $scope, $state, $window, $location, DS, $log) {
