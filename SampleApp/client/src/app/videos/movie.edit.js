define([], function() {
  var diName = 'MovieEditCtrl';
  return {
    __register__: function(mod) {
      mod.controller(diName, ['$rootScope', '$scope', '$state', '$window', '$location', 'ds.movie', '$log', MovieEditCtrl]);
      return mod;
    }
  };

  function MovieEditCtrl($rootScope, $scope, $state, $window, $location, DS, $log) {
